...
@section('title', 'Edit Viewing Schedule')

@section('content')

<div>
    <h1 class="page-title">Edit Viewing Schedule</h1>
    <p class="page-subtitle">Update viewing schedule for booking #{{ $viewing->bookService->id }}</p>
</div>
...
<!-- Edit Viewing Schedule Form -->
<div class="card">
    <div class="card-header">
        <h2 class="card-title">Update Viewing Schedule Details</h2>
    </div>
    
    <form action="{{ route('client.viewing.update', $viewing->id) }}" method="POST">
        @csrf
        @method('PUT')
        ...
        <div class="form-grid">
            ...
            <div class="form-group">
                ...
                <input 
                    ...
                    min="{{ date('Y-m-d') }}"
                    value="{{ old('viewing_date', $viewing->viewing_date->format('Y-m-d')) }}"
                    required
                >
                @error('viewing_date')
            ...
            <div class="form-group">
                ...
                >
                    ...
                    <option value="Public" {{ old('viewing_type', $viewing->viewing_type) === 'Public' ? 'selected' : '' }}>Public</option>
                    <option value="Private" {{ old('viewing_type', $viewing->viewing_type) === 'Private' ? 'selected' : '' }}>Private</option>
                    <option value="Family Only" {{ old('viewing_type', $viewing->viewing_type) === 'Family Only' ? 'selected' : '' }}>Family Only</option>
                </select>
                @error('viewing_type')
                    <span class="form-error">{{ $message }}</span>
                @enderror
            ...
            <div class="form-group">
                ...
                <input 
                    ...
                    value="{{ old('location', $viewing->location) }}"
                >
            ...
            <div class="form-group">
                ...
                <textarea 
                    ...
                    rows="3"
                >{{ old('address', $viewing->address) }}</textarea>
                <small style="color: #718096; font-size: 0.85rem; margin-top: 0.25rem; display: block;">
            ...
            <div class="form-group" style="grid-column: 1 / -1;">
                ...
                <textarea 
                    ...
                    rows="4"
                >{{ old('special_requests', $viewing->special_requests) }}</textarea>
                <small style="color: #718096; font-size: 0.85rem; margin-top: 0.25rem; display: block;">
        ...
        <div class="form-actions">
            <a href="{{ route('client.viewing.show', $viewing->id) }}" class="btn btn-secondary">
                Cancel
            </a>
